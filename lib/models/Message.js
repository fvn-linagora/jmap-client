...
export default class Message extends Model {
  ...
  setIsFlagged(isFlagged) {
    ...
    const {$Flagged, ..._keywords} = this.keywords; // *eslint no-unused-vars: ["error", { "ignoreRestSiblings": true }]

    return this.update(isFlagged ? { keywords: {..._keywords, $Flagged: isFlagged } } : { keywords: {..._keywords } } );
  }
  ...
  setIsUnread(isUnread) {
    ...
    const {$Seen, ..._keywords} = this.keywords; // *eslint no-unused-vars: ["error", { "ignoreRestSiblings": true }]

    return this.update(isUnread ? { keywords: {..._keywords } } : { keywords: {..._keywords, $Seen: !isUnread } } );
  }
  ...
  setIsAnswered(isAnswered) {
    ...
    const {$Answered, ..._keywords} = this.keywords; // *eslint no-unused-vars: ["error", { "ignoreRestSiblings": true }]

    return this.update(isAnswered ? { keywords: {..._keywords, $Answered: isAnswered } } : { keywords: {..._keywords } } );
  }
