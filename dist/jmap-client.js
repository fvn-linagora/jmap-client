...
var Client = function () {
  ...
  _createClass(Client, [{
    ...
    value: function withAuthAccess(access) {
      ...
      _Utils2.default.assertRequiredParameterHasType(access, 'access', _AuthAccess2.default);

      this.authScheme = 'X-JMAP';
      this.authToken = access.accessToken;
      ['username', 'apiUrl', 'eventSourceUrl', 'uploadUrl', 'downloadUrl', 'versions', 'extensions'].forEach(function (property) {
    ...
    value: function _authenticateResponse(data, continuationCallback) {
      ...
      if (data.loginId && data.accessToken === undefined) {
        ...
        return new _AuthAccess2.default(data);
      } else {
     ...
     * @param options.keywords {Boolean} This corresponds whether the message is flagged or not
     *
     ...
     * The _mailboxIds_ and _keyword.$Draft_ properties of the given _message_ will be overridden by this method.
     *
    ...
    value: function _createMessage(message, role, mailbox) {
      ...
      var clientId = this._generateClientId(),
        ...
        var _ref = message.keywords || {},
            $Draft = _ref.$Draft,
            keywords = _objectWithoutProperties(_ref, ['$Draft']);

        message.keywords = _MailboxRole2.default.DRAFTS.value === role.value ? _extends({}, keywords, { $Draft: true }) : _extends({}, keywords);
        /* jshint ignore:end*/
...
var _MailCapabilities = require('./MailCapabilities');

var _MailCapabilities2 = _interopRequireDefault(_MailCapabilities);

var _AccountCapabilities = require('./AccountCapabilities');

var _AccountCapabilities2 = _interopRequireDefault(_AccountCapabilities);
...
var Account = function (_Model) {
  ...
  function Account(jmap, id, opts) {
    ...
    _this.capabilities = _Utils2.default._nullOrNewInstance(opts.capabilities, _AccountCapabilities2.default);
    _this.mail = _Utils2.default._nullOrNewInstance(opts.mail, _MailCapabilities2.default);
    _this.contacts = _Utils2.default._nullOrNewInstance(opts.contacts, _Capabilities2.default);
    _this.calendars = _Utils2.default._nullOrNewInstance(opts.calendars, _Capabilities2.default);
    return _this;
  }
...
},{"../utils/Utils.js":32,"./AccountCapabilities":6,"./Capabilities":11,"./MailCapabilities":14,"./Model.js":19}],6:[function(require,module,exports){
'use strict';
 ...
 */
function AccountCapabilities(opts) {
  _classCallCheck(this, AccountCapabilities);
...
exports.default = AccountCapabilities;
module.exports = exports['default'];
...
},{"../utils/JSONBuilder.js":31,"../utils/Utils.js":32,"./Model.js":19}],8:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":32}],9:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":32,"./AuthMethod":10}],10:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":32,"./Model.js":19}],13:[function(require,module,exports){
'use strict';
...
var MailCapabilities = function (_Capabilities) {
  ...
  function MailCapabilities(opts) {
    ...
    var _this = _possibleConstructorReturn(this, (MailCapabilities.__proto__ || Object.getPrototypeOf(MailCapabilities)).call(this, opts));

    _this.maxSizeMessageAttachments = opts.maxSizeMessageAttachments || 0;
    _this.canDelaySend = !!opts.canDelaySend;
...
},{"./Capabilities":11}],15:[function(require,module,exports){
'use strict';
...
var Mailbox = function (_Model) {
   ...
   * @param [opts.unreadMessages=0] {Number} The number of messages in this mailbox having neither keyword $Seen nor keyword $Draft set.
   * @param [opts.totalThreads=0] {Number} The number of threads where at least one message in the thread is in this mailbox.
   * @param [opts.unreadThreads=0] {Number} The number of threads where at least one message is missing both keywords $Seen and $Draft.
   *
   * @see Model
   */
...
},{"../utils/Utils.js":32,"./MailboxRole.js":16,"./Model.js":19}],16:[function(require,module,exports){
'use strict';
...
var Message = function (_Model) {
  ...
  _createClass(Message, [{
    ...
    /**
     * Updates $Flagged keyword property of this {@link Message}.
     *
    ...
    value: function setIsFlagged(isFlagged) {
      ...
      var _keywords2 = this.keywords,
          $Flagged = _keywords2.$Flagged,
          _keywords = _objectWithoutProperties(_keywords2, ['$Flagged']);

      return this.update(isFlagged ? { keywords: _extends({}, _keywords, { $Flagged: isFlagged }) } : { keywords: _extends({}, _keywords) });
      /* jshint ignore:end */
    }
    ...
    value: function setIsUnread(isUnread) {
      ...
      var _keywords3 = this.keywords,
          $Seen = _keywords3.$Seen,
          _keywords = _objectWithoutProperties(_keywords3, ['$Seen']);

      return this.update(isUnread ? { keywords: _extends({}, _keywords) } : { keywords: _extends({}, _keywords, { $Seen: !isUnread }) });
      /* jshint ignore:end */
    }
    ...
    value: function setIsAnswered(isAnswered) {
      ...
      var _keywords4 = this.keywords,
          $Answered = _keywords4.$Answered,
          _keywords = _objectWithoutProperties(_keywords4, ['$Answered']);

      return this.update(isAnswered ? { keywords: _extends({}, _keywords, { $Answered: isAnswered }) } : { keywords: _extends({}, _keywords) });
      /* jshint ignore:end */
    }
...
},{"../utils/Utils.js":32,"./Attachment.js":7,"./EMailer.js":13,"./Model.js":19}],18:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":32,"./Model.js":19}],19:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":31,"../utils/Utils.js":32,"./Attachment.js":7,"./Model.js":19}],21:[function(require,module,exports){
'use strict';
...
},{"../errors/JmapError":3,"../utils/Utils.js":32,"./Model.js":19}],22:[function(require,module,exports){
'use strict';
...
},{"../utils/Utils.js":32,"./Model.js":19}],23:[function(require,module,exports){
'use strict';
...
},{"../utils/JSONBuilder.js":31,"../utils/Utils.js":32,"./Model.js":19}],24:[function(require,module,exports){
'use strict';
...
var JSONBuilder = function () {
   ...
   *         .appendIfDefined('hasAttachment', this.hasAttachment)
   *         .appendIfDefined('sender', this.sender)
   *         .build();
   *
   * @constructor
   **/
